...
ZmMimeTable._table[ZmMimeTable.APP_ZIMBRA_DOC]  	= {desc: ZmMsg.msWordDocument, image: "Doc", imageLarge: "Doc_48"};
ZmMimeTable._table[ZmMimeTable.APP_ZIMBRA_SLIDES]	= {desc: ZmMsg.msPPTDocument, image: "Presentation", imageLarge: "Presentation_48"};
ZmMimeTable._table[ZmMimeTable.APP_ZIMBRA_SPREADSHEET] = {desc: ZmMsg.msExcelDocument, image: "ZSpreadSheet", imageLarge: "ZSpreadSheet_48" };
