...
//TODO: Need to figure out usecase of `ZmMimeTable._icons`, and if unused, remove it's references
ZmMimeTable._icons = {
...
//TODO: `imageLarge` property should be removed as we are using svg's 
...
ZmMimeTable._table[ZmMimeTable.APP_ADOBE_PDF]		= {desc: ZmMsg.adobePdfDocument, image: "PDFDoc", imageLarge: "PDFDoc_48", dataUri: ZmMimeTable._icons.doc};
ZmMimeTable._table[ZmMimeTable.APP_ADOBE_PS]		= {desc: ZmMsg.adobePsDocument, image: "EPSDoc", imageLarge: "EPSDoc_48", dataUri: ZmMimeTable._icons.generic};
...
ZmMimeTable._table[ZmMimeTable.TEXT_DIRECTORY]		= {desc: ZmMsg.vCard, image: "ContactDoc", imageLarge: "ContactDoc_48", dataUri: ZmMimeTable._icons.generic};
ZmMimeTable._table[ZmMimeTable.TEXT_VCARD]			= {desc: ZmMsg.vCard, image: "ContactDoc", imageLarge: "ContactDoc_48", dataUri: ZmMimeTable._icons.generic};
ZmMimeTable._table[ZmMimeTable.TEXT_X_VCARD]		= {desc: ZmMsg.vCard, image: "ContactDoc", imageLarge: "ContactDoc_48P", dataUri: ZmMimeTable._icons.generic};
ZmMimeTable._table[ZmMimeTable.TEXT_CAL]			= {desc: ZmMsg.calendar, image: "EventDoc", imageLarge: "EventDoc_48", dataUri: ZmMimeTable._icons.generic};
