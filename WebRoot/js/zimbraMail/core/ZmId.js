...
// search panel
// TODO: buttons and menu items should use functions (with search as context)
 ...
 * and invite toolbar.
 * 
 * Examples: zb|CLV_CheckMail zb_TV_Reply zb_COMPOSE_Send zb_CLV_Nav_PageForward zb_CLV_Inv_ReplyAccept
 * 
 * @param context	[string]	toolbar context (ID of owning view)
...
ZmId.getViewId =
function(context) {
	return DwtId._makeId(ZmId.WIDGET, context, ZmId.VIEW);
};
...
// via getTreeItemId()
ZmId.TREEITEM_INBOX					= "zti_mail_2";
ZmId.TREEITEM_JUNK					= "zti_mail_4";
ZmId.TREEITEM_SENT					= "zti_mail_5";
ZmId.TREEITEM_DRAFTS				= "zti_mail_6";
ZmId.TREEITEM_TRASH_MAIL			= "zti_mail_3";
ZmId.TREEITEM_TRASH_CONTACTS		= "zti_contacts_3";
ZmId.TREEITEM_CONTACTS				= "zti_contacts_7";
ZmId.TREEITEM_CALENDAR				= "zti_calendar_10";
ZmId.TREEITEM_NOTEBOOK				= "zti_notebook_12";
ZmId.TREEITEM_TASKS					= "zti_tasks_15";
ZmId.TREEITEM_BRIEFCASE				= "zti_briefcase_16";
...
// IDs for search menu items that don't map directly to an item type (ZmId.ITEM_*)
ZmId.SEARCH_ANY				= "ANY";					// all item types
ZmId.SEARCH_SHARED			= "SHARED";					// include shared items
ZmId.SEARCH_PAS				= "PERSONAL_AND_SHARED";	
