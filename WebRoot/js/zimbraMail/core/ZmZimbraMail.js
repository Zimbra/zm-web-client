...
function(params) {
	...
	if (!this._components) {
		...
		var currentAppToolbar = new ZmCurrentAppToolBar(this._shell, appCtxt);
...
function() {
	...
	var appChooser = new ZmAppChooser(this._shell, null, buttons, this._TAB_SKIN_ENABLED, appCtxt);
