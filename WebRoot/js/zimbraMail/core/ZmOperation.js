...
//	ZmOperation.registerOp(ZmId.OP_MOUNT_FOLDER, {textKey:"mountFolder", image:"Folder"});
	...
	ZmOperation.registerOp(ZmId.OP_OPTS, {textKey:"options", tooltipKey:"options", image:"Preferences"});
    ...
    ZmOperation.registerOp(ZmId.OP_PRIORITY_FILTER, {textKey:"priorityMessageFilter"}, ZmSetting.PRIORITY_INBOX_ENABLED);
