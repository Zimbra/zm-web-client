...
function(sortBy) {
	...
	var search = new ZmSearch(this._appCtxt, this._query, types, sortBy, 0, ZmContactPicker.SEARCHFOR_MAX, this._contactSource);
...
ZmContactPickerListView.prototype._mouseUpAction =
function(ev, div) {
