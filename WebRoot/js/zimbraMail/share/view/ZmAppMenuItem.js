...
/**
 * @overview
 * This file defines the tab application drop down menu item.
 *
 */

/**
 * @class
 * This class represents a menu item that represents like a "tab" button inside the Menu, designed specifically for the row of
 * applications buttons at the top of the Zimbra Web Client interface that overflows the container & are showed as a drop down menu.
 *
 *
...
ZmAppMenuItem = function(params) {
    ...
    if (params.imageInfo) {
        this.setImage(params.imageInfo, DwtLabel.RIGHT);
    }
    else {
        if (params.leftImage) {
...
ZmAppMenuItem.prototype = new DwtMenuItem;
ZmAppMenuItem.prototype.constructor = ZmAppMenuItem;
 ...
 */
ZmAppMenuItem.prototype.toString =
    function() {
        return "ZmAppMenuItem";
    };
...
ZmAppMenuItem.prototype.TEMPLATE = "share.Widgets#ZmAppMenuItem";

//
// Public methods
//

ZmAppMenuItem.prototype.setImage =
    function(imageInfo, imageDirection) {
