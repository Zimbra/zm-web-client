...
ZmSetting.INIT[ZmSetting.BRANCH]						= [null, ZmSetting.T_CONFIG, ZmSetting.D_STRING, "ARMSTRONG"];
...
ZmSetting.INIT[ZmSetting.GROUP_MAIL_BY]					= ["zimbraPrefGroupMailBy", ZmSetting.T_PREF, ZmSetting.D_STRING, ZmSetting.GROUP_BY_MESSAGE];
