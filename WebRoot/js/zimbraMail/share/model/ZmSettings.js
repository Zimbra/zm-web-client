...
function() {
	...
	this.registerSetting("OFFLINE_SHOW_GLOBAL_INBOX",		{name:"offlineShowGlobalInbox", type:ZmSetting.T_METADATA, dataType:ZmSetting.D_BOOLEAN, defaultValue:true, section:ZmSetting.M_OFFLINE, isGlobal:true});
