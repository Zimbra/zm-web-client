...
ZmImg.I_FORWARD 		= ["ImgMailForwardIcon", 20, 16];
...
ZmImg.I_REPLY 			= ["ImgMailReplyIcon", 20, 16];
ZmImg.I_REPLY_ALL 		= ["ImgMailReplyAllIcon", 16, 16];
...
ZmImg.ID_FORWARD 		= ["ImgMailForwardIconDis", 16, 16];
...
ZmImg.ID_REPLY 			= ["ImgMailReplyIconDis", 16, 16];
ZmImg.ID_REPLY_ALL 		= ["ImgMailReplyAllIconDis", 16, 16];
