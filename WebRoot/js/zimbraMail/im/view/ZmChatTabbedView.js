...
function ZmChatTabbedView(parent, className, posStyle, controller) {
...
ZmChatTabbedView.prototype.constructor = ZmChatTabbedView;

ZmChatTabbedView.prototype._createHtml =
function() {
    this.getHtmlElement().innerHTML = "<b>this is tabbed view</b>";
}
