...
ZmBuddyListWindow = function(wm) {
	DwtResizableWindow.call(this, wm);
	var cont = new DwtComposite(this);
	...
	this.enableMoveWithElement(toolbar);
	...
	var win_size = this.getSize();
	wm.manageWindow(this, { x: wm_size.x - win_size.x - 50,
...
function() {
	if (!ZmBuddyListWindow.instance) {
		var wm = ZmChatMultiWindowView.getInstance().getShellWindowManager();
		ZmBuddyListWindow.instance = new ZmBuddyListWindow(wm);
	}
	return ZmBuddyListWindow.instance;
};
