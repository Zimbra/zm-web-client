...
function(settings) {
	...
	settings.registerSetting("COLOR_MESSAGES",					{name:"zimbraPrefColorMessages", type:ZmSetting.T_PREF, dataType:ZmSetting.D_BOOLEAN, defaultValue: false, isGlobal:true});
