...
function(settings) {
	...
	settings.registerSetting("ACCOUNT_SETTING_ENABLED",			{name:"zimbraAccountSettingEnabled", type:ZmSetting.T_COS, dataType:ZmSetting.D_BOOLEAN, defaultValue:false});
};
