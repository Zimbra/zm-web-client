...
ZmNote.prototype.getContent = function(callback, errorCallback) {
	if (this.name && this._content == null) {
		/***
		// create soap doc
		var soapDoc = AjxSoapDoc.create("GetWikiRequest", "urn:zimbraMail", null);
		...
		// execute call
		var handler = callback ? new AjxCallback(this, this._loadHandleResponse, [callback]) : null;
		var params = {
			soapDoc: soapDoc,
			asyncMode: Boolean(handler),
			callback: handler,
