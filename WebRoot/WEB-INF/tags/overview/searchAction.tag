        ...
        <c:choose>
            <c:when test="${empty newFolderName}">
                <app:status style="Warning">
                    <fmt:message key="actionNoSearchNameSpecified"/>
                </app:status>
            </c:when>
            <c:when test="${empty newSearchQuery}">
                <app:status style="Warning">
            ...
            <c:otherwise>
                ...
                <zm:createSearchFolder parentid="${parentid}" var="folder" name="${newFolderName}" query="${newSearchQuery}"/>
                <app:status>
                    <fmt:message key="actionSearchCreated">
    ...
    <c:when test="${!empty param.actionRename}">
        ...
        <c:choose>
            ...
            <c:when test="${!fn:startsWith(param.folderToRename, 'f:')}">
                <app:status style="Warning">
                    <fmt:message key="actionNoSearchRenameSelected"/>
                </app:status>
            </c:when>
            <c:otherwise>
                ...
                <app:status>
                    <fmt:message key="actionSearchRenamed">
    ...
    <c:when test="${!empty param.actionMove}">
        <c:choose>
            <c:when test="${!fn:startsWith(param.folderToMove, 'f:')}">
                <app:status style="Warning">
                    <fmt:message key="actionNoSearchMoveSelected"/>
                </app:status>
            </c:when>
            ...
            <c:otherwise>
                ...
                <app:status>
                    <fmt:message key="actionSearchMoved">
    ...
    <c:when test="${!empty param.actionDelete}">
        <c:choose>
            <c:when test="${!fn:startsWith(param.folderToDelete, 'f:')}">
                <app:status style="Warning">
                    <fmt:message key="actionNoSearchDeleteSelected"/>
                </app:status>
            </c:when>
            <c:otherwise>
                ...
                <app:status>
                    <fmt:message key="actionSearchMovedToTrash">
                        <fmt:param value="${folderName}"/>
                    </fmt:message>
                </app:status>
            </c:otherwise>
