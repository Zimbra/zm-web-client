...
<table cellpadding=0 cellspacing=0>
    <tr class='Tabs'>
        ...
        <td class='Tab ${selected=='mail' ? 'TabSelected' :'TabNormal'}'>
            <a href="<c:url value="/h/search"/>" accesskey="m">
        ...
        <td class='Tab ${selected=='compose' ? 'TabSelected' :'TabNormal'}'>
            <a href="<c:url value="/h/search?action=compose"/>" accesskey="e"><app:img src="mail/NewMessage.gif"/><span><fmt:message
                    key="compose"/></span></a>
        </td>
        <td class='TabSpacer'/>
        <td class='Tab ${selected=='contacts' ? 'TabSelected' :'TabNormal'}'>
            <a href="<c:url value="/h/search?st=contact"/>" accesskey="c"><app:img src="contacts/Contact.gif"/><span><fmt:message
                    key="contacts"/></span></a>
        </td>
        <td class='TabSpacer'/>
        <td class='Tab ${selected=='options' ? 'TabSelected' :'TabNormal'}'>
            <a href="<c:url value="/h/options"/>" accesskey="y"><app:img src="common/Preferences.gif"/><span><fmt:message
                    key="options"/></span></a>
        </td>
        <td class='TabSpacer'/>
        <c:choose>
