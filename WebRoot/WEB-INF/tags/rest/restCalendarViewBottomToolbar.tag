    ...
    <tr>
        <td align="left" class="TbBt">
            <c:if test="${not empty requestScope.zimbra_target_item_name}">
                <a href="${zm:cook(requestScope.zimbra_target_item_name)}.ics"><app:img src="startup/ImgCalendarApp.gif" alt="ics"/><span style='padding-left:5px'>${requestScope.zimbra_target_item_name}.ics</span></a>
            </c:if>
        </td>
