...
<zm:filterRule var="ruleVar" name="Automatic Spam Filter: ${address}" active="${true}" allconditions="${false}">
    <zm:addressCondition name="from" part="all" value="${address}" op="CONTAINS"/>
