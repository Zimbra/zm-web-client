        ...
        <c:choose>
            <c:when test="${context.searchResult.hasNextPage}">
                <div id="more-div" class='tr list-row'>
                    ...
                    <span class="td" onclick="return zClickLink('more-a')"><zm:nextResultUrl var="url" value="${context_url}" index="0" context="${context}"/>
                        ...
                        <a id="more-a" accesskey="${requestScope.next_accesskey}" class='zo_button next_button' href="${fn:escapeXml(url)}&show=more">More conversations...</a>
                    </div>
                    </span>
                    <span class="td">&nbsp;</span>
                </div>
            ...
            <c:otherwise>
                <div id="more-div" class='tr list-row'>
                    ...
                    <span class="td">
                        <div class="moreButton">
                        <a accesskey="${requestScope.next_accesskey}" class='zo_button_disabled next_button'>More conversations...</a>
                    </div>
                    </span>
                    <span class="td">&nbsp;</span>
                </div>
