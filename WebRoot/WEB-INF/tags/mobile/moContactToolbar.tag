    ...
    <div class="SubToolbar table">
        <div class="table-row">
            <div class="table-cell">
                <a accesskey="${requestScope.navlink_accesskey}" href="${urlTarget}?st=ab"><fmt:message key="addressBooks"/></a> &raquo;
                ...
                </a> &raquo; ${fn:escapeXml(fn:substring(contact.firstName,0,8))}...
            </div>
        </div>
    </div>
</c:if>
