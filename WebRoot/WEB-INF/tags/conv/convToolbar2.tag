    ...
    <tr>
        <td nowrap align=right>
            <c:if test="${convSearchResult.hasPrevPage}">
                ...
                <a <c:if test="${keys}"></c:if> href="${prevPageUrl}"><app:img altkey="left" src="arrows/LeftArrow.gif" border="0"/></a>
            </c:if>
            <c:if test="${!convSearchResult.hasPrevPage}">
            ...
            <c:if test="${convSearchResult.hasNextPage}">
                ...
                <a <c:if test="${keys}"></c:if> href="${nextPageUrl}"><app:img altkey="right" src="arrows/RightArrow.gif" border="0"/></a>
            </c:if>
            <c:if test="${!convSearchResult.hasNextPage}">
