				...
				<tr>
                    ...
                    <c:if test="${empty sessionScope.isLowRes or sessionScope.isLowRes eq false}">
                        <c:if test="${mailbox.features.conversations}">
                            <td><div class='vertSep'></div></td>
                            <td nowrap valign="middle" id="groupMailBy">
                            ...
                            <app:button id="OPSET" name="viewAction" text="actionGo" />
                        </c:if>
                        <td><div class='vertSep'></div></td>
                        <td nowrap valign="middle" id="readingPaneOp">
                        ...
                        <app:button id="OPVIEW" name="readingPaneAction" text="actionGo" />
                    </c:if>
				</tr>
			</table>
		</td>
