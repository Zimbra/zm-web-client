                            ...
                            <c:if test="${not hasTemplate}">
                                <tr>
                                    <td nowrap align='right' class='MsgHdrSent'>
                                        ...
                                        <span id="messageDisplayTime_${message.id}"><fmt:formatDate timeZone="${not empty timezone ? timezone : mailbox.prefs.timeZone}" pattern="${dateFmt}" value="${zm:contains(message.receivedDate,'1969') or zm:contains(message.receivedDate,'1970') ? message.sentDate : message.receivedDate}"/></span>
                                    </td>
                                </tr>
                            </c:if>
