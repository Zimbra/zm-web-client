            ...
            <c:when test="${zm:actionSet(param, 'actionCompose')}">
                ...
                <c:forEach items="${paramValues.id}" var="cid">
                    <c:if test="${not empty cid}">
                        ...
                        <c:if test="${not empty contact.email2 and empty workEmail and empty homeEmail}">
                            <c:set var="homeEmail" value="${contact.email2}"/>
                        </c:if>
                        <c:if test="${not empty contact.workEmail2 and empty workEmail and empty homeEmail}">
                            <c:set var="workEmail" value="${contact.workEmail2}"/>
                        </c:if>
                        <c:if test="${not empty contact.email3 and empty workEmail and empty homeEmail}">
                            <c:set var="homeEmail" value="${contact.email3}"/>
                        </c:if>
                        <c:if test="${not empty contact.workEmail3 and empty workEmail and empty homeEmail}">
