...
<script type="text/javascript" src="<c:url value='/yui/2.9.0-alfresco-20140211/yahoo-dom-event/yahoo-dom-event.js'/>"></script>
<script type="text/javascript" src="<c:url value='/yui/2.9.0-alfresco-20140211/connection/connection-min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/yui/2.9.0-alfresco-20140211/datasource/datasource-min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/yui/2.9.0-alfresco-20140211/json/json-min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/yui/2.9.0-alfresco-20140211/autocomplete/autocomplete-debug.js'/>"></script>
