...
#   - attribute values of the template are double-quoted
#   - attribute values of the html are single-quoted
#
...
<template id="ApptViewDesc">
	<tpl>
		...
		<div class='zcs-apptview-fieldSets'>
			<tpl if="organizer && !isOrganizer">
				<div class='zcs-apptview-fieldSet'>
					<div class='zcs-apptview-label'>{[ZtMsg.invOrganizerLabel]}</div>
					<div class='zcs-apptview-fields'>
						<div class='zcs-apptview-field'>
							<span id='{organizer.id}'>{organizer.name}</span>
						</div>
					</div>
				</div>
			</tpl>
						...
						<div class='zcs-apptview-field'>
							...
							<tpl for="attendees">
								<tpl if="ptst == [ZCS.constant.PSTATUS_ACCEPTED]">
									<span class='view-appt-accepted' id={id}>{name}</span>
								</tpl>

								<tpl if="ptst == [ZCS.constant.PSTATUS_TENTATIVE]">
									<span class='view-appt-tentative' id={id}>{name}</span>
								</tpl>

								<tpl if="ptst == [ZCS.constant.PSTATUS_DECLINED]">
									<span class='view-appt-declined' id={id}>{name}</span>
								</tpl>

								<tpl if="ptst == [ZCS.constant.PSTATUS_UNKNOWN]">
									<span class='view-appt-noresponse' id={id}>{name}</span>
								</tpl>
			...
			<tpl if="optAttendees">
				<div class='zcs-apptview-fieldSet'>
					<div class='zcs-apptview-label'>{[ZtMsg.invOptionalAttendeesLabel]}</div>
					<div class='zcs-apptview-fields'>
						<div class='zcs-apptview-field'>
							<tpl if="isOrganizer">
			...
			<tpl if="myResponse && !isOrganizer">
				<div class='zcs-apptview-fieldSet'>
					<div class='zcs-apptview-label'>{[ZtMsg.response]}</div>
					<div class='zcs-apptview-fields'>
						<div class='zcs-apptview-field'>
							<tpl if="myResponse == [ZCS.constant.PSTATUS_TEXT[ZCS.constant.PSTATUS_ACCEPTED]]">
								<span class='view-appt-accepted'>{[ZtMsg.accepted]}</span>
			...
			<tpl if="displayStatus">
				<div class='zcs-apptview-fieldSet'>
					<div class='zcs-apptview-label'>{[ZtMsg.display]}</div>
					<div class='zcs-apptview-fields'>
						<div class='zcs-apptview-field'>
