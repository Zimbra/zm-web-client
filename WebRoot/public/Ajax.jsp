...
<script type="text/javascript" src="<%= contextPath %>/js/ajax/dwt/core/DwtMovable.js<%= ext %>?v=<%= vers %>"></script>
<script type="text/javascript" src="<%= contextPath %>/js/ajax/dwt/core/DwtSizable.js<%= ext %>?v=<%= vers %>"></script>
