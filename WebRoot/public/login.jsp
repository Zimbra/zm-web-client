...
<body onload="onLoad();">
    ...
    <div class="LoginScreen">
        <div class="header">
            <img src='/img/nic/mail.gov-logo-new.png'/>
            <div class="menu">
                <span><a href='https://servicedesk.nic.in' target="_blank"><fmt:message key="contactUs"/></a></span>
                <span><a href='https://eforms.nic.in/' target="_blank"><fmt:message key="downloadForms"/></a></span>
                <span><a href='https://mail.gov.in/iwc_static/c11n/allDomain/layout/safe.html' target="_blank"><fmt:message key="safeEmail"/></a></span>
                <span><a href="https://mail.gov.in/iwc_static/c11n/allDomain/layout/policy.html" target="_blank"><fmt:message key="policies"/></a></span>
                <span><a href="https://email.gov.in/public/docs/Whats_New.pdf" target="_blank" ><fmt:message key="whatsNew"/></a></span>
                <span><a href="https://quicksms.emailgov.in/" target="_blank"><fmt:message key="quickSMS"/></a></span>
                <!-- <span><a>Login</a></span> -->
            </div>
        </div>
        <div class="pmBanner" >
             <span class="pmImage" style="width:100%; height:701.9px; background:#21529E;" > </span>
            <div class="govUtilities">
                <a><img src='/img/nic/1i.png'/></a>
                <a><img src='/img/nic/3i.png'/></a>
                <a><img src='/img/nic/5i.png'/></a>
                <a><img src='/img/nic/4i.png'/></a>
                <a><img src='/img/nic/2i.png'/></a>
            </div>
        </div>
        <div class="${smallScreen?'center-small':'center'}" style="left: 50%; right: auto; top: 55%;border: 1px solid white;border-radius: 5px;">
            <div class="contentBox" style="background-color: #12315f;">
                <h1>
                    <a href="https://www.zimbra.com/" id="bannerLink" target="_new" title='<fmt:message key="zimbraTitle"/>'>
                        <span class="ScreenReaderOnly" style="position: static !important; color: #fff; font-weight: 200;"><fmt:message key="logIN"/></span>
                        <span class="Img${smallScreen?'App':'Login'}Banner" style="display: none;"></span>
                    </a>
                </h1>
                ...
                <c:if test="${errorCode != null}">
                    <div id="ZLoginErrorPanel" style="background-color: #e1e1e1; border: 1px solid #d3d3d3; font-weight: 200;">
                        <table><tr>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <table class="form" style="color: #fff; font-weight: 200;">
                        <c:choose>
                            <c:when test="${not empty domainLoginRedirectUrl && param.sso eq 1 && empty param.ignoreLoginURL && (isAllowedUA eq true)}">
                                <tr>
                                <td colspan="2">
                            ...
                            <c:otherwise>
                                <c:choose>
                                    <c:when test="${not empty virtualacctdomain or not empty param.virtualacctdomain}">
                                        ...
                                        <td><input id="username" autocomplete="OFF" class="zLoginField" name="username" type="text" value="${fn:escapeXml(param.username)}" size="40" maxlength="${domainInfo.webClientMaxInputBufferLength}"/></td>
                                        </tr>
                                    </c:when>
                                    <c:otherwise>
                                        ...
                                        <td><input id="username" autocomplete="OFF" class="zLoginField" name="username" type="text" value="${fn:escapeXml(param.username)}" size="40" maxlength="${domainInfo.webClientMaxInputBufferLength}" autocapitalize="off" autocorrect="off"/></td>
                                        </tr>
                                        </c:otherwise>
                                </c:choose>
                                <tr>
                                ...
                                <input type="submit" class="ZLoginButton DwtButton" value="<fmt:message key="login"/>" style="border-color: transparent;"/>
                                </td>
                                </tr>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <tr>
                        <td></td><td><a href="https://passapp.emailgov.in" target="_blank"><lable style="color: white"><fmt:message key="forgotPassword"/></lable></a></td>
                        </tr>
                        </c:if>
                        </table>
                    </c:otherwise>
        ...
        <div class="${smallScreen?'Footer-small':'Footer'}" style="background-color: #fff; padding: 1rem 0 1rem 0; width: 100%;">
            <div style="background-image: url('/img/nic/digi-india.png'); background-repeat: no-repeat; height: 115px; width: 67px; float: left; padding: 0 0 0 1rem; margin: 0 0 0 1rem;"></div>
            <div style="float: left; text-align: left; line-height: 1.2rem;margin-top: 32px;">
                <div style="font-weight: bold;"><fmt:message key="emailService"/></div>
                <div><fmt:message key="partOfDigitalIndia"/></div>
                <div style="font-weight: bold;"><fmt:message key="governmentOfIndia"/></div>
                <div><fmt:message key="ministryOfEait"/></div>
                <div><a href="http://www.nic.in/"><fmt:message key="nic"/></a></div>
                <div>
                    <a href="https://facebook.com/NICIndia" style="margin: 0px;" target="_blank"><img src="/img/nic/fb.png" style="width: 30px;"></a>
                    <a href="https://twitter.com/NICMeity" style="margin: 0px;" target="_blank"> <img src="/img/nic/twitter.png" style="width: 30px;"></a>
                    <a href="https://www.linkedin.com/company/national-informatics-centre/" style="margin: 0px;" target="_blank"> <img src="/img/nic/linkedin.png" style="width: 30px;"></a>
                </div>
            </div>
            <div style="text-align: right; padding: 0 2rem 0 0; line-height: 1.7rem;">
                <div><fmt:message key="browserErrorMessage"/>  <a href="http://www.whatbrowser.org/" style="padding-left: 5px;"><fmt:message key="browserClickHere"/></a></div>
                <!-- <div>For slow internet connections (Data Card, Low end configurations Desktop). <a href="#">Click Here</a></div> -->
                <div style="position: absolute; bottom: 0; right: 2rem;">
                    ...
                    <span style="font-weight: bold;"><fmt:message key="internetAccess"/>: </span>
                    <span style="padding: 0 0.5rem 0 0.5rem;"><a href="https://mail.gov.in/iwc_static/c11n/allDomain/layout/smime-faq.pdf" target="_blank" ><fmt:message key="mimeFAQ"/></a></span>
                </div>
            </div>
