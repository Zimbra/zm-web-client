    ...
    <div class="LoginScreen">
        <div class="header">
            ...
            <div class="menu">
                ...
                <span><a href='https://msgapp.emailgov.in/OnlineForms/' target="_blank"><fmt:message key="downloadForms"/></a></span>
        ...
        <div class="${smallScreen?'Footer-small':'Footer'}" style="background-color: #fff; padding: 1rem 0 1rem 0;">
            ...
            <div style="text-align: right; padding: 0 2rem 0 0; line-height: 1.7rem;">
                <div><fmt:message key="browserErrorMessage"/>  <a href="http://www.whatbrowser.org/"><fmt:message key="browserClickHere"/></a></div>
