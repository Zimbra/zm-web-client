...
<body onload="onLoad();">
            ...
            <ul>
                <li>
                    <a href="https://mail.gov.in/iwc_static/c11n/allDomain/layout/safe.html" target="_blank">
                        <span class="icon ico-email"><img src="/img/nic/safemail.svg" alt="Safe Email"></span>SAFEEmail 
                    </a>
                </li>
                <li>
                    <a href="https://msgapp.emailgov.in/docs/policy.html" target="_blank">
                        <span class="icon ico-policy"><img src="/img/nic/policies.svg" alt="Policies"></span>Policies
                    </a>
                </li>
                <li>
                    <a href="/public/docs/Whats_New.pdf" target="_blank">
                        <span class="icon ico-faqs"><img src="/img/nic/faq.svg" alt="FAQs"></span>What's New
                    </a>
                </li>
                <li>
                    <a href="https://quicksms.emailgov.in/" target="_blank">
                        <span class="icon ico-ksms"><img src="/img/nic/quick-sms.svg" alt="Quick SMS"></span>Quick SMS
                    </a>
                </li>
                <li>
                    <a href="https://quicksms.emailgov.in/mobile/#/login" target="_blank">
                        <span class="icon ico-mobile"><img src="/img/nic/update-mobile-no.svg" alt="Update Mobile Number"></span>Update Mobile Number
                    </a>
                </li>
                <li>
                    <a href="https://msgapp.emailgov.in/profile/" target="_blank">
                        <span class="icon ico-profile"><img src="/img/nic/profile.svg" alt="Profile & Last Login"></span>Profile &amp; Last Login
                    </a>
                </li>
                <li>
                    <a href="https://logapp.emailgov.in" target="_blank">
                        <span class="icon ico-log"><img src="/img/nic/logapp.svg" alt="Log-APP"></span>Log-APP
                    </a>
                </li>
                <li>
                    <a href="https://quicksms.emailgov.in/idlookup/#/login" target="_blank">
                        <span class="icon ico-id"><img src="/img/nic/idlook.svg" alt="ID-LookUp"></span>ID-LookUp
                    </a>
                </li>
                <li>
                    <a href="https://servicedesk.nic" target="_blank">
                        <span class="icon ico-id"><img src="/img/nic/policies.svg" alt="ID-LookUp"></span>Contact Us
                    </a>
                </li>
                <li>
                    <a href="https://kavach.mail.gov.in" target="_blank">
                        <span class="icon ico-policy"><img src="/img/nic/userpolicy.png" alt="Policies"></span>User Policy
                    </a>
                </li>
            </ul>
        </nav>
      <div id="content">
            <div class="menu-trigger">
                <span class="icon ico-menu"><img src="/img/nic/menu.svg" alt="Safe Email"/></span>
                <p style="color: white;margin-left: -8px;display:inline-block;"> Menu </p>
            </div>
        </div>
...
<g>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                            ...
                            <c:otherwise>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <tr>
                                        <td colspan="2"><input id="username" autocomplete="OFF" placeholder="user@nic.in" class="zLoginField" name="username" type="text" value="${fn:escapeXml(param.username)}" size="40" maxlength="${domainInfo.webClientMaxInputBufferLength}" autocapitalize="off" autocorrect="off"/></td>
                                        </tr>
                                        </c:otherwise>
                                </c:choose>
                                <tr>
                                ...
                                <button type="submit"  value="<fmt:message key="login"/>">Sign In</button>
                                </td>
                                </tr>
                                    <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;"> 
                                <a href="http://www.whatbrowser.org/" target="_blank" style="color:white;text-decoration: none;">Site compatibility (Best Viewed)</a>
                            </td>
                        </tr>
                        </table>
                    </c:otherwise>
    ...
    <div class="bottom">
          <div class="bottom-content">
                <div class="niclogo">
                    <a href="https://www.nic.in/" target="_blank"><img src="/img/nic/logo.png" alt="NationalInformatics Centre" ></a>
                </div>
                <div class="nicinfo">
          ...
          <div class="logo-scroller ">
              ...
              <div class="slider">
                  <a href="https://egreetings.gov.in/" target="_blank"><img src="/img/nic/e-greetings-logo.png" alt="eGreetings"></a> 
                  <a href="https://www.india.gov.in/" target="_blank"><img src="/img/nic/india-gov-logo.png" alt="India Gov"></a>
                  <a href="https://esamiksha.gov.in/" target="_blank"><img src="/img/nic/e-samiksha-logo.png" alt="e Samiksha" ></a>
                  <a href="https://registry.gov.in/" target="_blank"><img src="/img/nic/domain-gov-logo.png" alt="domain Gov" ></a>
                  <a href="https://data.gov.in/" target="_blank"><img src="/img/nic/data-gov-logo.png" alt="Data Gov"></a>
                  <a href="https://www.mygov.in/" target="_blank"><img src="/img/nic/mygov.png" alt="Data Gov"></a>
                  <a href="http://www.pmindia.gov.in/" target="_blank"><img src="/img/nic/pmo.png" alt="Data Gov"></a>
                  <a href="http://nkn.gov.in/" target="_blank"><img src="/img/nic/nationalknowledge.png" alt="Data Gov"></a>
              </div>
          </div>
    </div>
