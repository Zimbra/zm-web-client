...
<body onload="onLoad();">
    ...
    <div class="LoginScreen">
        <div class="header">
            ...
            <div class="menu">
                <span><a href='https://servicedesk.nic.in' target="_blank">Contact Us</a></span>
                <span><a href='https://msgapp.emailgov.in/OnlineForms/' target="_blank">Download Forms</a></span>
                <span><a href='https://mail.gov.in/iwc_static/c11n/allDomain/layout/safe.html' target="_blank">Safe Email</a></span>
                <span><a href="https://mail.gov.in/iwc_static/c11n/allDomain/layout/policy.html" target="_blank">Policies</a></span>
                <span><a href="https://email.gov.in/public/docs/Whats_New.pdf" target="_blank" >What's New</a></span>
                <span><a href="https://quicksms.emailgov.in/" target="_blank">QuickSMS</a></span>
                <!-- <span><a>Login</a></span> -->
            </div>
        </div>
        <div class="pmBanner" >
            ...
            <div class="contentBox" style="background-color: #12315f;">
                <h1>
                    <a href="https://www.zimbra.com/" id="bannerLink" target="_new" title='<fmt:message key="zimbraTitle"/>'>
                        <span class="ScreenReaderOnly" style="position: static !important; color: #fff; font-weight: 200;">Log in</span>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <tr>
                        <td></td>   <td><a href="https://passapp.emailgov.in" target="_blank"><lable style="color: white">Forgot Password ? Click here</lable></a></td>
                        </tr>
                        </c:if>
                        </table>
                    </c:otherwise>
        ...
        <div class="${smallScreen?'Footer-small':'Footer'}" style="background-color: #fff; padding: 1rem 0 1rem 0;">
            ...
            <div style="float: left; text-align: left; line-height: 1.2rem;margin-top: 32px;">
                <div style="font-weight: bold;">Email Services</div>
                <div>A part of Digital India</div>
                <div style="font-weight: bold;">Government of India</div>
                <div>Ministry of Electronics and Information Technology</div>
                <div><a href="http://www.nic.in/">National Informatics Center</a></div>
                <div>***</div>
            </div>
            <div style="text-align: right; padding: 0 2rem 0 0; line-height: 1.7rem;">
                <div>This site can be best viewed in Firefox 3.5 and above, IE 9 and above. To check your browser version <a href="http://www.whatbrowser.org/">Click Here</a></div>
                ...
                <div style="position: absolute; bottom: 0; right: 2rem;">
                    <span style="font-weight: bold;"> For Intranet access: </span>
                    <span style="padding: 0 0.5rem 0 0.5rem;"><a href="https://intranic.nic.in/" target="_blank">INTRANIC </a></span>
                    <span style="padding: 0 0.5rem 0 0.5rem;"><a href="https://ehradm.nic.in/" target="_blank">NICEHRAdm</a></span>
                    <span style="padding: 0 0.5rem 0 0.5rem;"><a href="http://inoc.nic.in/" target="_blank" > NIC INOC</a></span>
                    <span style="padding: 0 0.5rem 0 0.5rem;"><a href="https://portal.otc.nic.in/" target="_blank">NIC OTC</a></span>
                    <span style="font-weight: bold;">For Internet access: </span>
                    <span style="padding: 0 0.5rem 0 0.5rem;"><a href="https://mail.gov.in/iwc_static/c11n/allDomain/layout/smime-faq.pdf" target="_blank" >S/MIME FAQ</a></span>
                </div>
            </div>
