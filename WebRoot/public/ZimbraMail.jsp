...
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/share/view/ZmHtmlEditor.js<%= ext %>?v=<%= vers %>"></script>
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/share/view/dialog/ZmDialog.js<%= ext %>?v=<%= vers %>"></script>
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/share/view/dialog/ZmErrorDialog.js<%= ext %>?v=<%= vers %>"></script>
...
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/share/view/dialog/ZmBalloonDialog.js<%= ext %>?v=<%= vers %>"></script>
...
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/share/view/picker/ZmObjectPicker.js<%= ext %>?v=<%= vers %>"></script>
...
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/calendar/view/ZmAppointmentDialog.js<%= ext %>?v=<%= vers %>"></script>
...
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/calendar/view/ZmEditInstanceSeriesView.js<%= ext %>?v=<%= vers %>"></script>
<script type="text/javascript" src="<%= contextPath %>/js/zimbraMail/calendar/view/ZmFreeBusyView.js<%= ext %>?v=<%= vers %>"></script>
