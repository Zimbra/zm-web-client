...
var toc = (function () {
  ...
  var $_3f76zeqyjepc6ujk = { create: create };

  var tocId = $_3f76zeqyjepc6ujk.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_4cth3jqxjepc6uje.getTocClass(editor);
    var headerTag = $_4cth3jqxjepc6uje.getTocHeader(editor);
    var selector = generateSelector($_4cth3jqxjepc6uje.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_4cth3jqxjepc6uje.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_4cth3jqxjepc6uje.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_2w851eqtjepc6uiw.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_2w851eqtjepc6uiw.updateToc(editor);
    });
  };
  var $_9d8m2sqsjepc6uin = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_4cth3jqxjepc6uje.getTocClass(editor);
  ...
  var $_6qi40yqzjepc6ujl = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_2w851eqtjepc6uiw.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_4cth3jqxjepc6uje.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_db06v9r0jepc6ujs = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_9d8m2sqsjepc6uin.register(editor);
    $_db06v9r0jepc6ujs.register(editor);
    $_6qi40yqzjepc6ujl.setup(editor);
  });
  function Plugin () {
  }
