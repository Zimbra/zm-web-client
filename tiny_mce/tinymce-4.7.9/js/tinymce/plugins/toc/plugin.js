...
var toc = (function () {
  ...
  var $_ahsqjvqyjeo9pagi = { create: create };

  var tocId = $_ahsqjvqyjeo9pagi.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_8vbu2eqxjeo9paga.getTocClass(editor);
    var headerTag = $_8vbu2eqxjeo9paga.getTocHeader(editor);
    var selector = generateSelector($_8vbu2eqxjeo9paga.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_8vbu2eqxjeo9paga.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_8vbu2eqxjeo9paga.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_bjghzjqtjeo9pag3.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_bjghzjqtjeo9pag3.updateToc(editor);
    });
  };
  var $_dt3z10qsjeo9pafz = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_8vbu2eqxjeo9paga.getTocClass(editor);
  ...
  var $_3xyldtqzjeo9pagj = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_bjghzjqtjeo9pag3.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_8vbu2eqxjeo9paga.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_735yn8r0jeo9pagn = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_dt3z10qsjeo9pafz.register(editor);
    $_735yn8r0jeo9pagn.register(editor);
    $_3xyldtqzjeo9pagj.setup(editor);
  });
  function Plugin () {
  }
