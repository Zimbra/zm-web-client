...
public	class	JsChangeLogUtil {
	...
	private	static	final	String		ARG_DELIVERY_DIR = "-delivery.dir";
	private	static	final	String		ARG_TEMPLATE_DIR = "-template.dir";
    ...
    public static void main(String[] args) throws Exception {
       	...
       	JsChangeLogTemplateUtil template = new JsChangeLogTemplateUtil(templateDirectory, deliveryDirectory);
       	template.writeChangeLog(baselineInv, currentInv);
    }
